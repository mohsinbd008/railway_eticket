...
<!--                                <h5> Please register carefully once you created you can not edit or modify</h5> -->
                    ...
                    <tr>
                        <td> Phone: </td> <td> <input type="text" name="userPhone" ng-model="objCtrl.obj.userPhone" required/> 
                            <span ng-show="objForm.userPhone.$error.required" class="msg-val">*</span> </td>
                    </tr>
                    <tr>
                        <td> Email: </td> <td> <input type="text" name="userEmail" ng-model="objCtrl.obj.userEmail" required/> 
                            <span ng-show="objForm.userEmail.$error.required" class="msg-val">*</span> </td>
                    </tr>
                    <tr>
                        <td>  Address </td> <td> <input type="text" name="userAddress" ng-model="objCtrl.obj.userAddress" required/> 
...
<!--                            <div ng-if="objCtrl.flag == 'edit'">
                ...
                If your are already registered please <a href="http://localhost:8080/railway_eticket/login/home">login </a> here to visit more.
            </form>
<!--            <table>
                <tr><th>ID </th> 
                    <th>User Type</th> 
        ...
        <script src="${pageContext.request.contextPath}/static/js/controller/user_registration_controller.js"></script>
